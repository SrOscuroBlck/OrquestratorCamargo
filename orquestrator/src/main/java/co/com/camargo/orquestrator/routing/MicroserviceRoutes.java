...
public class MicroserviceRoutes extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        from("direct:getStepOne")
                ...
                .setProperty("step1Response", body()) // Guardar el body del paso 1 en una propiedad
                .end();
        ...
        from("direct:getStepTwo")
                ...
                .setProperty("step2Response", body()) // Guardar el body del paso 2 en una propiedad
                .end();
        ...
        from("direct:getStepThree")
                ...
                .setProperty("step3Response", body()) // Guardar el body del paso 3 en una propiedad
                .end();
        ...
        from("direct:startOrchestration")
                ...
                .process(exchange -> {
                    // Extraer solo el campo 'answer' de la respuesta del microservicio
                    String step1Response = exchange.getIn().getBody(String.class);
                    String step1Answer = extractAnswer(step1Response);  // Extraer 'answer'
                ...
                .process(exchange -> {
                    ...
                    String step2Answer = extractAnswer(step2Response);  // Extraer 'answer'
                ...
                .process(exchange -> {
                    ...
                    String step3Answer = extractAnswer(step3Response);  // Extraer 'answer'
                    exchange.setProperty("step3Answer", step3Answer);
                })
                .process(exchange -> {
                    // Recuperar las respuestas de los tres pasos
